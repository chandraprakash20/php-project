    ...
    <?php include('message.php');  ?>  
        <div class="card">
            <div class="card-header">
                <h4>VIEW NOTICE </h4>
                <a href="notice-add.php" class="btn btn-primary float-end">ADD NOTICE</a>
            </div>
            <div class="card-body">
                    ...
                    <?php 
                        ...
                        if(mysqli_num_rows($notice_run)>0)
                        {
                             foreach($notice_run as $notice)
                            {
                                ...
                                <td><a href="notice-edit.php?notice_id=<?=$notice['notice_id']?>" class="btn btn-info">EDIT</a></td>
                                <td>
                                    <form action="code.php" method="POST">
                                    <button type="submit" name="notice-delete" value="<?=$notice['notice_id'];?>"class="btn btn-danger">DELETE</button>
