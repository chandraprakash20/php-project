...
<?php include('message.php');  ?>  
    <div class="card">
        ...
        <div class="card-body">
        <form action="rentcode.php" method="POST" enctype="multipart/form-data">
                       
                       <div class="row">
                      
                       <div class="col-md-12 mb-3">
                           <label for="">RENT AMOUNT </label>
                           <input type="text" name="rent_amount"  required class="form-control">
                       </div>
           ...
           <div class="col-md-12 mb-3">
                           ...
                           <input type="date" name="rent_date"  required class="form-control">
                       </div>
                       <div class="col-md-12 mb-3">
...
<div class="col-md-12 mb-3">
                       <button type="submit" name="rent-add"class="btn btn-primary">ADD RENT</button>       
                   </div>  
                   </div>
               </form>
        </div>
